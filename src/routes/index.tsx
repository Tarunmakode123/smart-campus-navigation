  ...
  head: () => ({
    meta: [
      { title: "WayFindr — Find Your Way. Instantly." },
      {
        name: "description",
        content:
          "Real-world QR-based indoor navigation system. Scan entrance QR, search destination, and follow live turn-by-turn map guidance.",
      },
    ],
  }),
  component: WayFindrHome,
});

function WayFindrHome() {
